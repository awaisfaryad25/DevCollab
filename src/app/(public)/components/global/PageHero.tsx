        ...
        <div className="mx-auto w-full max-w-7xl px-6 md:px-0">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-5 pt-4">
              <Link
                href={href}
                className="group flex items-center gap-2 font-semibold border border-white hover:bg-white px-5 py-3 rounded-lg relative cursor-pointer overflow-hidden"
              >
                <span className="relative z-10 text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-brand-blue group-hover:to-brand-green transition-all duration-300">
                  {btnTitle}
                </span>
                <span className="relative z-10 size-6 flex items-center justify-center rounded-full transition-all duration-300 group-hover:bg-linear-to-r group-hover:from-brand-blue group-hover:to-brand-green">
